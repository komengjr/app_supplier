                ...
                <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
                    <div class="navbar-vertical-content scrollbar pt-2">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            @php
                            $menu = DB::table('z_menu_user')->join('z_menu_sub', 'z_menu_sub.menu_sub_code', '=', 'z_menu_user.menu_sub_code')
                            ->join('z_menu', 'z_menu.menu_code', '=', 'z_menu_sub.menu_code')
                            ->where('z_menu_user.access_code', Auth::user()->access_code)->get()
                            ->unique('menu_code');
                            @endphp
                            ...
                            <li class="nav-items">
                                ...
                                @php
                                $sub_menu = DB::table('z_menu_user')->join('z_menu_sub','z_menu_sub.menu_sub_code','=','z_menu_user.menu_sub_code')
                                ...
                                @php
                                $sub = DB::table('z_menu_sub_main')->where('menu_sub_code',$sub_menus->menu_sub_code)->get();
                                @endphp
                            <li class="nav-item">
                                <a class="nav-link dropdown-indicator" href="#menu-{{ $sub_menus->id_menu_sub }}" role="button"
                                    data-bs-toggle="collapse" aria-expanded="false" aria-controls="dashboard">
                                    <div class="d-flex align-items-center ">
                                        <span class="nav-link-icon">
                                            <span class="{{ $sub_menus->menu_sub_icon }}">
                                            </span>
                                        </span>
                                        <span class="nav-link-text ps-1">{{ $sub_menus->menu_sub_name }}</span>
                                    </div>
                                </a>
                                <ul class="nav collapse show" id="menu-{{ $sub_menus->id_menu_sub }}">
                                    @foreach ($sub as $item)
                                    <li class="nav-item">
                                        <a class="nav-link " href="{{ url($item->menu_main_sub_code  . '/' . $item->menu_main_sub_link) }}"
                                            aria-expanded="true">
                                            <div class="d-flex align-items-center ">
                                                <span class="nav-link-icon"><span class="{{$item->menu_main_sub_icon}}"></span></span>
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="{{ route('master_suplier') }}" role="button"
                                    aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-swatchbook"></span></span><span
                                            class="nav-link-text ps-1">Master Suplier</span>
                                    </div>
                                </a>
                                <a class="nav-link" href="{{ route('master_barang') }}" role="button"
                                    aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fab fa-stumbleupon-circle"></span></span><span
                                            class="nav-link-text ps-1">Master Barang</span>
                                    </div>
                                </a>
                                <a class="nav-link" href="{{ route('master_jasa') }}" role="button"
                                    aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fab fa-uikit"></span></span><span
                                            class="nav-link-text ps-1">Master Jasa</span>
                                    </div>
                                </a>
                                <a class="nav-link" href="{{ route('master_rujukan') }}" role="button"
                                    aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fab fa-hubspot"></span></span><span
                                            class="nav-link-text ps-1">Master Rujukan</span>
                                    </div>
                                </a>
                                <a class="nav-link" href="{{ route('master_pemeriksaan') }}" role="button"
                                    aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-bong"></span></span><span
                                            class="nav-link-text ps-1">Master Pemeriksaan</span>
                                    </div>
                                </a>
                                <a class="nav-link" href="{{ route('master_penilaian') }}" role="button"
                                    aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
