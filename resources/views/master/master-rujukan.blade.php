        ...
        <div class="card bg-100 shadow-none border">
            <div class="row gx-0 flex-between-center">
                ...
                <div class="col-xl-auto px-3 py-2">
                    ...
                    <h4 class="text-primary fw-bold mb-0">Master <span class="text-info fw-medium">Rujukan</span></h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-auto">
                ...
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-rujukan"
                            id="button-tambah-data-rujukan" data-code="123"><span class="fab fa-superpowers"></span> Tambah Rujukan</button>
