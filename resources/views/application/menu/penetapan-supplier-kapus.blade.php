        ...
        <div class="card bg-100 shadow-none border border-danger">
            <div class="row gx-0 flex-between-center">
                ...
                <div class="col-xl-auto px-3 py-2">
                    ...
                    <h4 class="text-danger fw-bold mb-0">Data <span class="text-danger fw-medium">Supplier</span>
                    </h4>
                </div>
            </div>
        </div>
...
<div class="card mb-3">
    <div class="card-header bg-danger">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="m-0"><span class="badge bg-danger m-0 p-0">Data Supplier</span></h3>
            </div>
            <div class="col-auto">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <button class="btn btn-falcon-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modal-suplier-lg" id="button-preview-penetapan" data-code="{{ $datas->data_penawaran_code }}">Preview</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<script>
    $(document).on("click", "#button-preview-penetapan", function(e) {
        e.preventDefault();
        ...
        $.ajax({
            url: "{{ route('evaluasi_kapus_penetapan_supplier_kapus_preview') }}",
            type: "POST",
            cache: false,
            data: {
                "_token": "{{ csrf_token() }}",
