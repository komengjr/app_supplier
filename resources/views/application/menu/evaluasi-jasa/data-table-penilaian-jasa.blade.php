    ...
    <tbody>
        ...
        @foreach ($supplier as $sup)
            <tr>
                ...
                @endforeach
                <td>
                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modal-supplier-full"
                        id="button-proses-nilai-supplier" data-supplier="{{$sup->m_supplier_code}}" data-code="{{ $code  }}"
