<div class="card mb-3">
    <div class="card-header">
        <div class="row align-items-center">
            <div class="col">
                <h5 class="mb-0">Details Barang</h5>
            </div>
            <div class="col-auto">
            ...
            <div class="col-lg col-xxl-5">
                ...
                <div class="row">
                    <div class="col-5 col-sm-4">
                        <p class="fw-semi-bold mb-1">Nama Barang</p>
                    </div>
                    <div class="col">{{$data->m_barang_name}}</div>
                </div>
                <div class="row">
                    <div class="col-5 col-sm-4">
    ...
    <div class="card-footer border-top text-end">
        <div class="row align-items-center">
            <div class="col-auto">
                <input type="text" name="code_supplier" id="code_barang" value="{{$code}}" hidden>
            </div>
