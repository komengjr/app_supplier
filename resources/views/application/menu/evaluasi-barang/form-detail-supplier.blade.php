<div class="card mb-3">
    <div class="card-header">
        <div class="row align-items-center">
            <div class="col">
                <h5 class="mb-0">Details Supplier</h5>
            </div>
            <div class="col-auto">
            ...
            <div class="col-lg col-xxl-5">
                ...
                <div class="row">
                    <div class="col-5 col-sm-4">
                        <p class="fw-semi-bold mb-1">Nama Supplier</p>
                    </div>
                    <div class="col">{{$data->m_supplier_name}}</div>
                </div>
                <div class="row">
                    <div class="col-5 col-sm-4">
    ...
    <div class="card-footer border-top text-end">
        <div class="row align-items-center">
            <div class="col-auto">
                ...
                <input type="text" name="code_supplier" id="code_supplier" value="{{$data->m_supplier_code}}" hidden>
            </div>
            <div class="col float-end">
                <a class="btn btn-falcon-primary ms-2 " href="#!" data-bs-toggle="modal"
                    data-bs-target="#modal-supplier" id="button-tambah-data-barang">
                    <span class="far fa-file-archive me-1"></span>Tambah Penilaian Barang
                </a>
            </div>
        </div>
    </div>
...
<div class="card mb-3">
    <div class="card-header bg-300 d-flex justify-content-between">
        ...
        <button class="btn btn-falcon-primary" id="button-simpan-fix-proses-penilaian">Simpan Evaluasi</button>
    </div>
                    ...
                    <tr>
                        ...
                        @foreach ($cat as $cats)
                            @php
                                $value = DB::table('log_penilaian_cab')
                                    ...
                                    ->where('log_penilaian_cab.m_supplier_code', $code)
                        ...
                        <td>
                            <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                ...
                                data-supplier="{{$code}}" data-code="{{ $brgs->m_barang_code  }}"
