<div class="modal-body p-0">
    ...
    <div class="row g-3 p-4">
        <div class="col-12">
            ...
            <select name="data_barang" id="data_pemeriksaan" class="form-control choices-single-jenis" required>
            ...
            <div class="col-12 pt-3">
                <button class="btn btn-primary float-end" type="button" id="button-pilih-data-pemeriksaan"><span
                        class="fas fa-save"></span> Pilih</button>
            </div>
        </div>
    </div>
</div>
