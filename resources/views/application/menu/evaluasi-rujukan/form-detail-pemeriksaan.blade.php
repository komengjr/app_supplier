<div class="card mb-3">
        ...
        <div class="row">
            <div class="col-lg col-xxl-5">
                ...
                <div class="row">
                    ...
                    <div class="col">{{$data->m_pemeriksaan_name}}</div>
                </div>
                <div class="row">
                    <div class="col-5 col-sm-4">
    ...
    <div class="card-footer border-top text-end">
        <div class="row align-items-center">
            <div class="col-auto">
                <input type="text" name="data_pemeriksaan" id="data_pemeriksaan" value="{{$code}}" hidden>
            </div>
            <div class="col float-end">
                <a class="btn btn-falcon-primary ms-2 " href="#!" data-bs-toggle="modal" data-bs-target="#modal-rujukan" id="button-tambah-data-rujukan">
                    <span class="far fa-file-archive me-1"></span>Tambah Penilaian Rujukan
                </a>
            </div>
        </div>
    </div>
...
<div class="card mb-3">
    <div class="card-header bg-300 d-flex justify-content-between">
        ...
        <button class="btn btn-falcon-primary" id="button-simpan-fix-proses-penilaian-rujukan" data-code="{{ $periode }}">Simpan Evaluasi</button>
    </div>
        ...
        <table id="example" class="table table-striped" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @endforeach
                    <td>
                        <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modal-rujukan-full" id="button-proses-nilai-rujukan" data-rujukan="{{$ruj->m_rujukan_code}}" data-code="{{ $code  }}" data-periode="{{ $periode }}">Proses</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
