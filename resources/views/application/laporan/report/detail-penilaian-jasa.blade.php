        ...
        <table id="example" class="table table-striped border" style="width:100%" border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {{ $sup->m_supplier_name }} ( <strong
                            class="text-primary">{{ $sup->data_supp_jasa_cab_score }}</strong> )
                        <table>
                            <tr>
                                @foreach ($cat as $cats)
                            ...
                            <tr>
                                @foreach ($cat as $cats)
                                @php
                                $point = DB::table('log_penilaian_jasa_cab')
                                ...
                                ->where('log_penilaian_jasa_cab.log_master_code',$periode->log_master_code)
