...
@php
$no_cabang = DB::table('master_cabang_no')->where('master_cabang_no_code',$periode->log_master_cabang)->first();
$no_document = DB::table('log_master')->where('log_master_cabang',$periode->log_master_cabang)->get();
$nourut = 1;
@endphp
@if ($no_cabang)
@php
...
<body>
    ...
    <main style="padding-top: 0px;">
        ...
        <table style="width: 100%; padding-top: 50px;" border="0">
            <tr>
                @php
                $cabang = DB::table('master_cabang')->where('master_cabang_code',$periode->log_master_cabang)->first();
                @endphp
                @if ($cabang)
