<div class="card-header bg-300 d-flex justify-content-between">
    <div>
        ...
        <button class="btn btn-falcon-default btn-sm ms-1 ms-sm-2 d-none d-sm-inline-block" type="button"
            data-bs-toggle="modal" data-bs-target="#modal-laporan" id="button-detail-rujukan-lampiran-terpilih"
            data-code="{{ $code }}">Detail Penilaian Rujukan</button>
    </div>
    <div class="d-flex">
        ...
        layout: {
            topStart: {
                buttons: [{
                    ...
                    text: 'Export Excel',
                    title: 'Data Rekap Evaluasi Suplier Barang {{ date('
                    ymdhis ') }}'
                }],
            }
        }
