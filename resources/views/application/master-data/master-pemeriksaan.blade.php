            ...
            <div class="card bg-100 shadow-none border">
                <div class="row gx-0 flex-between-center">
                    ...
                    <div class="col-xl-auto px-3 py-2">
                        ...
                        <h4 class="text-primary fw-bold mb-0">Master <span class="text-info fw-medium">Pemeriksaan</span></h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card mb-3">
        <div class="card-header bg-primary">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="m-0"><span class="badge bg-primary m-0 p-0">Master Pemeriksaan</span></h3>
                </div>
                <div class="col-auto">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                            <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-pemeriksaan"
                                id="button-tambah-data-pemeriksaan" data-code="123"><span class="fab fa-superpowers"></span>
            ...
            <table id="example" class="table table-striped nowrap" style="width:100%">
                ...
                <tbody>
                    ...
                    @foreach ($data as $datas)
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>{{ $datas->m_pemeriksaan_code }}</td>
                            <td>{{ $datas->m_pemeriksaan_name }}</td>
                            <td><button class="btn btn-falcon-warning btn-sm">Disable</button></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
...
@section('base.js')
    ...
    <script>
        $(document).on("click", "#button-tambah-data-pemeriksaan", function (e) {
            ...
            $.ajax({
                url: "{{ route('master_pemeriksaan_add') }}",
                type: "POST",
                cache: false,
                data: {
                    "_token": "{{ csrf_token() }}",
