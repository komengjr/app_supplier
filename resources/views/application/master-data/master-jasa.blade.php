                ...
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-barang"
                            id="button-tambah-data-jasa" data-code="123"><span class="fab fa-superpowers"></span> Tambah Jasa</button>
...
@endsection
@section('base.js')
<div class="modal fade" id="modal-jasa" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1"
...
<script>
    $(document).on("click", "#button-tambah-data-jasa", function(e) {
        e.preventDefault();
