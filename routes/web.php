...
Route::prefix('app')->group(function () {
    ...
    Route::post('periode-penilaian/update-team-penilaian', [MenuController::class, 'periode_penilaian_update_team_penilaian'])->name('periode_penilaian_update_team_penilaian');
...
Route::prefix('master-data')->group(function () {
    ...
    Route::post('suplier/add-email', [MasterController::class, 'master_suplier_add_email'])->name('master_suplier_add_email');
    Route::post('suplier/add-email-save', [MasterController::class, 'master_suplier_add_email_save'])->name('master_suplier_add_email_save');
    Route::post('suplier/detail-document', [MasterController::class, 'master_suplier_detail_document'])->name('master_suplier_detail_document');
    ...
    Route::post('suplier/show/penilaian/remove-alamat-supplier', [MasterController::class, 'master_suplier_show_penilaian_remove_alamat_supplier'])->name('master_suplier_show_penilaian_remove_alamat_supplier');
    ...
    Route::post('jasa/remove-detail-penilaian', [MasterController::class, 'master_jasa_remove_detail_penilaian'])->name('master_jasa_remove_detail_penilaian');
    ...
    Route::post('rujukan/detail-penilaian', [MasterController::class, 'master_rujukan_detail_penilaian'])->name('master_rujukan_detail_penilaian');
    Route::post('rujukan/remove-detail-penilaian', [MasterController::class, 'master_rujukan_remove_detail_penilaian'])->name('master_rujukan_remove_detail_penilaian');
